                ...
                <div class="table-responsive">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td  >
                                        <a href="?page=mahasiswa&actions=detail3&NIM=<?= $data['NIM'] ?>" class="btn btn-info btn-xs">
                                            <span class="fa fa-eye"></span>
                                        </a>
                                        <a href="?page=mahasiswa&actions=edit3&NIM=<?= $data['NIM'] ?>" class="btn btn-warning btn-xs">
                                            <span class="fa fa-edit"></span>
                                        </a>
                                        <a href="?page=mahasiswa&actions=delete3&NIM=<?= $data['NIM'] ?>" class="btn btn-danger btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="7">
                                    <a href="?page=mahasiswa&actions=tambah3" class="btn btn-info btn-sm">
                                        Tambah Data
