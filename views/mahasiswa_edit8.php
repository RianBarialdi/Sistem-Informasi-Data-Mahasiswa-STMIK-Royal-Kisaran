<?php
$NIM=$_GET['NIM'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM mahasiswa8 WHERE NIM ='$NIM'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                ...
                <div class="panel-footer">
                    <a href="?page=mahasiswa&actions=tampil8" class="btn btn-danger btn-sm">
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE mahasiswa8 SET Nama='$Nama',Kelas='$Kelas',Jurusan='$Jurusan',Tahun_Masuk='$Tahun_Masuk',Jenis_Kelamin='$Jenis_Kelamin',
    ...
    if ($query){
        echo "<script>window.location.assign('?page=arsip&actions=tampil8');</script>";
    }else{
