...
if($_POST){
    ...
    $sql="INSERT INTO mahasiswa8 VALUES ('$NIM','$Nama','$Kelas','$Jurusan','$Tahun_Masuk','$Jenis_Kelamin','$Alamat','$Agama','$Email','$Nomer_Hp','$Keterangan')";
    //buat sql
    ...
    if ($query){
        echo "<script>window.location.assign('?page=mahasiswa&actions=tampil8');</script>";
    }else{
