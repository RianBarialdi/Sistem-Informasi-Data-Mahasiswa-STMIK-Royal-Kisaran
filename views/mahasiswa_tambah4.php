...
if($_POST){
    ...
    $sql="INSERT INTO mahasiswa4 VALUES ('$NIM','$Nama','$Kelas','$Jurusan','$Tahun_Masuk','$Jenis_Kelamin','$Alamat','$Agama','$Email','$Nomer_Hp','$Keterangan')";
    //buat sql
    ...
    if ($query){
        echo "<script>window.location.assign('?page=mahasiswa&actions=tampil4');</script>";
    }else{
