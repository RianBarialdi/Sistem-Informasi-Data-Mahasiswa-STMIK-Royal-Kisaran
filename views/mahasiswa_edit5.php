<?php
$NIM=$_GET['NIM'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM mahasiswa5 WHERE NIM ='$NIM'") or die ("SQL Edit error");
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE mahasiswa5 SET Nama='$Nama',Kelas='$Kelas',Jurusan='$Jurusan',Tahun_Masuk='$Tahun_Masuk',Jenis_Kelamin='$Jenis_Kelamin',
    ...
    if ($query){
        echo "<script>window.location.assign('?page=arsip&actions=tampil5');</script>";
    }else{
